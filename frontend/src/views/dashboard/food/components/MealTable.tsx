            ...
            return (
              <div key={key} className="border-t border-gray-100">
                <button
                  ...
                  className="w-full px-5 py-2.5 flex justify-between items-center text-sm hover:bg-gray-50 transition-colors"
                >
                ...
                {isOpen && (
                  <div className="px-5 pb-3 space-y-1">
                    {meal.items.map((item, i) => (
                      <div
                        key={i}
                        className="flex justify-between text-xs text-gray-600 py-1 border-t border-gray-50"
                      >
                        <span>
                          {item.name}
