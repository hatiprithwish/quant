        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-3">
            {data.byBucket.map(b => (
              ...
              >
                <div className="w-3 h-3 rounded-full" style={{ backgroundColor: b.bucket_color }} />
                <span className="text-sm text-gray-700 dark:text-gray-300 flex-1">{b.bucket_name}</span>
            ...
            {data.days.length === 0 ? (
              ...
              data.days
                ...
                .map(a => (
                  ...
                  >
                    <div className="w-2.5 h-2.5 rounded-full shrink-0" style={{ backgroundColor: a.bucket_color }} />
                    <span className="text-xs text-gray-400 dark:text-gray-500 shrink-0">{a.bucket_name}</span>
